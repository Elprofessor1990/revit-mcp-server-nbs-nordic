...
await build({ entryPoints: ["tests/agent/runtime.test.ts"], bundle: true,
  platform: "node", format: "esm", external: ["sql.js"],
  outfile: ".test-build/agent-runtime.test.mjs",
...
const result = spawnSync(process.execPath, ["--test", ".test-build/agent-runtime.test.mjs"], { stdio: "inherit" });
